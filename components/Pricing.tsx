      ...
      <div className="container px-6 py-8 mx-auto">
        <div className="xl:items-center xl:-mx-4 xl:flex">
          <div className="flex flex-col items-center xl:items-start xl:mx-8">
            <h1 className="text-3xl font-medium text-white capitalize lg:text-4xl dark:text-white">
              Our Pricing Plan
            </h1>
            ...
            <p className="mt-4 font-light text-white dark:text-gray-300">
          ...
          <div className="flex-1 xl:mx-8">
            <div className="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
              <div className="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
                <div className="p-6">
                  <h1 className="text-xl font-medium text-white capitalize lg:text-3xl dark:text-white">
                    Essential
                  </h1>
                  ...
                  <h2 className="mt-4 text-2xl font-medium text-gray-300 sm:text-4xl dark:text-gray-300">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-8 space-y-4">
                    <div className="flex items-center">
                      ...
                      <span className="mx-4 text-gray-300 dark:text-gray-300">
