  ...
  if (!showMember) {
    return (
      <button
        ...
        className="w-12 flex justify-center items-center rounded-md bg-slate-800 hover:bg-slate-700 hover:animate-bounceLeft"
      >
        <svg
          width="24"
          height="24"
    ...
    return (
      <div className="flex flex-col flex-shrink-0 w-full h-screen z-10 absolute md:relative md:z-0 text-white md:w-1/4 border-l border-gray-300 bg-slate-600">
